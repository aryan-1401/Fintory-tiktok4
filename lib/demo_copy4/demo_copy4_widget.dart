...
class DemoCopy4Widget extends StatefulWidget {
  const DemoCopy4Widget({Key? key}) : super(key: key);

  @override
  _DemoCopy4WidgetState createState() => _DemoCopy4WidgetState();
}

class _DemoCopy4WidgetState extends State<DemoCopy4Widget> {
                ...
                children: [
                  Align(
                    ...
                    child: FlutterFlowVideoPlayer(
                      path: 'assets/videos/Untitled_(5).mp4',
