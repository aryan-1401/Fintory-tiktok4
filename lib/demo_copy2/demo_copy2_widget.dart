...
class DemoCopy2Widget extends StatefulWidget {
  const DemoCopy2Widget({Key? key}) : super(key: key);

  @override
  _DemoCopy2WidgetState createState() => _DemoCopy2WidgetState();
}

class _DemoCopy2WidgetState extends State<DemoCopy2Widget> {
                ...
                children: [
                  Align(
                    ...
                    child: FlutterFlowVideoPlayer(
                      path: 'assets/videos/Untitled_(2).mp4',
